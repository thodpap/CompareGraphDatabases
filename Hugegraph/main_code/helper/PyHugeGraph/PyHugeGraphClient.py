...
class HugeGraphClient(object):
    ...
    def __init__(self, host, port, graph_name=None):
        self.host = ""
        if host.startswith("http://"):
            self.host = host + ":" + port
        else:
            self.host = "http://" + host + ":" + port
        # self.host += "/graphs/hugegraph"    
    ...
    def traverser_kout(self, source, direction, max_depth, label="", nearest="true"):
        """
    ...
    def traverser_kneighbor(self, source, direction, max_depth, label=""):
        """
